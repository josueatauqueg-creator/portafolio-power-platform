export const uiTranslations = {
  es: {
    ...
    projects: {
      ...
      detailAlt: 'Detalle de',
      galleryAlt: 'Galeria de'
    },
    categories: {
      Todos: 'Todos',
    ...
    services: {
      eyebrow: 'Servicios',
      title: 'Soluciones para convertir procesos manuales en sistemas claros',
      copy: 'Desde prototipos rapidos hasta aplicaciones empresariales integradas con datos, reportes y notificaciones.',
    ...
    contact: {
      ...
      company: 'Empresa',
      companyPlaceholder: 'Empresa o cliente',
      email: 'Correo',
  ...
  en: {
    ...
    projects: {
      eyebrow: 'Projects',
      title: 'Automation, business app, and data integration case studies',
      copy: 'Each project is loaded from an editable file so you can add new cases without touching the visual components.',
      searchPlaceholder: 'Search by client, technology, or project',
      noResults: 'No projects were found with those filters.',
      ...
      detailAlt: 'Details of',
      galleryAlt: 'Gallery image for'
    },
    categories: {
      Todos: 'All',
      'Power Apps': 'Power Apps',
    ...
    modal: {
      ...
      license: 'License or related cost',
      benefits: 'Benefits'
    },
    app: {
      whatsapp: 'Contact through WhatsApp',
      backToTop: 'Back to top'
    },
    techStack: {
      eyebrow: 'Technologies',
      title: 'Stack focused on productivity, data, and business integration',
    ...
    services: {
      eyebrow: 'Services',
      title: 'Solutions to turn manual processes into clear systems',
      copy: 'From quick prototypes to business applications integrated with data, reports, and notifications.',
    ...
    contact: {
      ...
      company: 'Company',
      companyPlaceholder: 'Company or client',
      email: 'Email',
